...
def main(args):
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for i in range(len(orig_data.keys())):
            ...
            assert len(actions) == len(agentview_images) == len(agentview_segs) == len(object_infos_strs)
            ...
            ep_data_grp.create_dataset("agentview_seg", data=agentview_segs)
            ep_data_grp.create_dataset("eye_in_hand_seg", data=eye_in_hand_segs)
            ep_data_grp.create_dataset("object_infos", data=object_infos_strs)
