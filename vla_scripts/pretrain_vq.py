...
def main():
    ...
    for epoch in tqdm.trange(args.epochs):
        for _ in tqdm.trange(len(train_loader)):
            ...
            print('codes: {}, combinations: {}, encoder_loss: {}, loss_state:{}, recon_loss: {}'.format(len(torch.unique(vq_code)), len(torch.unique(vq_code, dim=0)), encoder_loss, vq_loss_state, vqvae_recon_loss))
